  ...
  return (
    <div className="relative min-h-screen w-full bg-[#0a0514] text-white font-sans overflow-hidden flex flex-col items-center justify-center p-6 pt-24">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.pexels.com/photos/14553707/pexels-photo-14553707.jpeg?cs=srgb&dl=pexels-bibekghosh-14553707.jpg&fm=jpg')`,
        }}
      >
        ...
        <div className="relative inline-block">
          <h1 
            ...
            style={{ 
               ...
               textShadow: '2px 0 #bc39f3, -1px 0 #00fff9' // Static subtle color separation
            }}
          >
            WIEMPOWER
          </h1>
      ...
      <style>{`
        .soft-glitch::after {
          ...
          height: 100%;
          opacity: 0.4;
          clip-path: inset(45% 0 45% 0); /* A thin slice through the middle */
